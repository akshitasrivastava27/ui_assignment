      ...
      <div class="col-md-4 mb-4"> 
          <div class="card" style="width: 100%;">
              ...
              <div class="card-body">
                  ...
                  <p class="card-text">Venue: ${data.venue}<br>Date and Time: ${data.date}<br>Ticket Price: ${data.ticket}<br>Contact Details: ${data.contact}</p>
              </div>
          </div>
      </div>
  `;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var toastList = toastElList.map(function(toastEl) {
    return new bootstrap.Toast(toastEl, {autohide: true, delay: 1000}) // Initialize the toast
  });
  ...
  window.showToast = function(message) {
    ...
    if (toastBody) {
      toastBody.textContent = message; // Set message
